...
Defined in: [sdk/sdk-common/src/simulation/interfaces/Steps.ts:125](https://github.com/OasisDEX/summerfi-monorepo/blob/1ef6231288fcd880252de20d0ddd07a0cdcc78fa/sdk/sdk-common/src/simulation/interfaces/Steps.ts#L125)

## Extends

- [`Step`](Step.md)\<[`Import`](../../../enumerations/SimulationSteps.md#import), \{
  `externalPosition`: [`IExternalLendingPosition`](../../../interfaces/IExternalLendingPosition.md);
\}\>
