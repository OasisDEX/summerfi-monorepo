# Function: divideTokenAmountByPercentage()

```ts
function divideTokenAmountByPercentage(tokenAmount, percentage): ITokenAmountData;
```

Defined in: [sdk/sdk-common/src/common/utils/PercentageUtils.ts:28](https://github.com/OasisDEX/summerfi-monorepo/blob/1402deca577ac262b618bb0671f1c1173a1fd152/sdk/sdk-common/src/common/utils/PercentageUtils.ts#L28)
