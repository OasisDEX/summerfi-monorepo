...
export const encodeAavePartialTakeProfit = (
  position: PositionLike,
  triggerData: AavePartialTakeProfitTriggerData,
  ...
  const operationName =
    triggerData.withdrawToken === position.debt.token.address
      ? OPERATION_NAMES.aave.v3.WITHDRAW_TO_DEBT
      : OPERATION_NAMES.aave.v3.WITHDRAW
