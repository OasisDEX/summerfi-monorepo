...
export type BorrowPosition_Filter = {
  ...
  borrowCumulativeDepositInCollateralToken_not_in?: InputMaybe<
  ...
  borrowCumulativeWithdrawInCollateralToken_not_in?: InputMaybe<
    Array<Scalars['BigDecimal']['input']>
  >
...
export type GetPositionQuery = {
  ...
  earnPosition?: {
    ...
    oasisEvents?: Array<{
      ...
      debtToken?: { __typename?: 'Token'; address: string; symbol: string; decimals: bigint } | null
    }> | null
  } | null
}
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    ): Promise<GetPositionQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetPositionQuery>(GetPositionDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'GetPosition',
