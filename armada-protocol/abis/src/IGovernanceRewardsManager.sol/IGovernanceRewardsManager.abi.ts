export const IGovernanceRewardsManagerAbi = [
  {
    inputs: [
      {
  ...
  {
    inputs: [],
    name: 'DecayController__RewardsManagerAlreadySet',
    type: 'error',
  },
  {
    inputs: [],
    name: 'DecayController__ZeroAddress',
    type: 'error',
  },
  {
    inputs: [
  ...
  {
    inputs: [],
    name: 'DECAY_SMOOTHING_FACTOR_BASE',
    outputs: [
      {
        internalType: 'uint256',
        name: '',
  ...
  },
  {
    ...
    name: 'updateSmoothedDecayFactor',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  },
  {
    ...
    name: 'userSmoothedDecayFactor',
    outputs: [
      {
        internalType: 'uint256',
        name: 'smoothedDecayFactor',
        type: 'uint256',
      },
    ],
    stateMutability: 'view',
