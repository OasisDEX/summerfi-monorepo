...
import { ChainId, SubgraphProviderType } from '@summerfi/sdk-common'
  ...
  implements ISubgraphProvider
{
  ...
  constructor(params: { configProvider: IConfigurationProvider }) {
    super({ ...params, type: SubgraphProviderType.EarnProtocol })
   ...
   */
  private _formatArmadaSubgraphUrl(params: {
   ...
   */
  private _extractSwapRoutes(protocols: ArmadaSubgraphRoute[]): SwapRoute[] {
   ...
   */
  private _getConfig(): {
    config: ArmadaSubgraphProviderConfig
    chainIds: ChainId[]
  } {
