...
export class MakerPlugin implements ProtocolPlugin<MakerPoolId> {
    ...
    async getPool(makerPoolId: unknown): Promise<MakerLendingPool> {
        ...
        this._validatePoolId(makerPoolId)
    ...
    private _validatePoolId(candidate: unknown): asserts candidate is MakerPoolId {
