...
export interface FlashloanStep extends Step<
...
export interface PullTokenStep extends Step<
  SimulationSteps.PullToken,
  { amount: ReferenceableField<ITokenAmount> }
> {}

export interface DepositBorrowStep extends Step<
...
export interface PaybackWithdrawStep extends Step<
...
export interface SkippedStep extends Step<
...
export interface SwapStep extends Step<
...
export interface RepayFlashloanStep extends Step<
...
export interface NewPositionEventStep extends Step<
...
export interface OpenPosition extends Step<
