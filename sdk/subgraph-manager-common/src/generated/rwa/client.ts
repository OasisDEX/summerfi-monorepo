...
export enum AdminAction {
  ...
  ArkRemoved = 'ARK_REMOVED',
  VaultCapChanged = 'VAULT_CAP_CHANGED',
  VaultMinBufferChanged = 'VAULT_MIN_BUFFER_CHANGED',
  VaultPerformanceRateChanged = 'VAULT_PERFORMANCE_RATE_CHANGED',
...
export enum ArkDailySnapshot_OrderBy {
  ...
  VaultIsWhitelistOpen = 'vault__isWhitelistOpen',
...
export enum ReceiptActivity_OrderBy {
  ...
  VaultCurrentRound = 'vault__currentRound',
  VaultFlavor = 'vault__flavor',
  VaultId = 'vault__id',
  VaultMinPositionSize = 'vault__minPositionSize'
}
...
export enum RoundsVaultPair_OrderBy {
  ...
  InputVaultCreatedAt = 'inputVault__createdAt',
  InputVaultCreatedAtBlock = 'inputVault__createdAtBlock',
  InputVaultCurrentRound = 'inputVault__currentRound',
  InputVaultFlavor = 'inputVault__flavor',
  InputVaultId = 'inputVault__id',
  InputVaultMinPositionSize = 'inputVault__minPositionSize',
  InstitutionId = 'institutionId',
  LastUpdated = 'lastUpdated',
  OutputVault = 'outputVault',
  OutputVaultCreatedAt = 'outputVault__createdAt',
  OutputVaultCreatedAtBlock = 'outputVault__createdAtBlock',
  OutputVaultCurrentRound = 'outputVault__currentRound',
  OutputVaultFlavor = 'outputVault__flavor',
  OutputVaultId = 'outputVault__id',
  OutputVaultMinPositionSize = 'outputVault__minPositionSize',
  RegisteredAt = 'registeredAt',
  RegisteredAtBlock = 'registeredAtBlock',
  TargetVault = 'targetVault',
  TargetVaultApr7d = 'targetVault__apr7d',
  TargetVaultApr30d = 'targetVault__apr30d',
  TargetVaultApr90d = 'targetVault__apr90d',
  TargetVaultApr180d = 'targetVault__apr180d',
  TargetVaultApr365d = 'targetVault__apr365d',
  TargetVaultCalculatedApr = 'targetVault__calculatedApr',
  TargetVaultCreatedBlockNumber = 'targetVault__createdBlockNumber',
  TargetVaultCreatedTimestamp = 'targetVault__createdTimestamp',
  TargetVaultCumulativeProtocolSideRevenueUsd = 'targetVault__cumulativeProtocolSideRevenueUSD',
  TargetVaultCumulativeSupplySideRevenueUsd = 'targetVault__cumulativeSupplySideRevenueUSD',
  TargetVaultCumulativeTotalRevenueUsd = 'targetVault__cumulativeTotalRevenueUSD',
  TargetVaultDepositCap = 'targetVault__depositCap',
  TargetVaultDepositLimit = 'targetVault__depositLimit',
  TargetVaultDetails = 'targetVault__details',
  TargetVaultId = 'targetVault__id',
  TargetVaultInputTokenBalance = 'targetVault__inputTokenBalance',
  TargetVaultInputTokenPriceUsd = 'targetVault__inputTokenPriceUSD',
  TargetVaultIsWhitelistOpen = 'targetVault__isWhitelistOpen',
  TargetVaultLastUpdatePricePerShare = 'targetVault__lastUpdatePricePerShare',
  TargetVaultLastUpdateTimestamp = 'targetVault__lastUpdateTimestamp',
  TargetVaultMaxRebalanceOperations = 'targetVault__maxRebalanceOperations',
  TargetVaultMinimumBufferBalance = 'targetVault__minimumBufferBalance',
  TargetVaultName = 'targetVault__name',
  TargetVaultOutputTokenPriceUsd = 'targetVault__outputTokenPriceUSD',
  TargetVaultOutputTokenSupply = 'targetVault__outputTokenSupply',
  TargetVaultPerformanceFeeRate = 'targetVault__performanceFeeRate',
  TargetVaultPricePerShare = 'targetVault__pricePerShare',
  TargetVaultRebalanceCount = 'targetVault__rebalanceCount',
  TargetVaultStakedOutputTokenAmount = 'targetVault__stakedOutputTokenAmount',
  TargetVaultStakingRewardsManager = 'targetVault__stakingRewardsManager',
  TargetVaultSymbol = 'targetVault__symbol',
  TargetVaultTipRate = 'targetVault__tipRate',
  TargetVaultTotalValueLockedUsd = 'targetVault__totalValueLockedUSD',
  TargetVaultWithdrawableTotalAssets = 'targetVault__withdrawableTotalAssets',
  TargetVaultWithdrawableTotalAssetsUsd = 'targetVault__withdrawableTotalAssetsUSD'
}
...
export enum RoundsVault_OrderBy {
  ...
  ExchangeAssetTokenDecimals = 'exchangeAssetToken__decimals',
  ExchangeAssetTokenId = 'exchangeAssetToken__id',
  ExchangeAssetTokenLastPriceBlockNumber = 'exchangeAssetToken__lastPriceBlockNumber',
  ExchangeAssetTokenLastPriceUsd = 'exchangeAssetToken__lastPriceUSD',
  ExchangeAssetTokenName = 'exchangeAssetToken__name',
  ExchangeAssetTokenSymbol = 'exchangeAssetToken__symbol',
  Flavor = 'flavor',
  Id = 'id',
  MinPositionSize = 'minPositionSize',
  Pair = 'pair',
  PairActive = 'pair__active',
  PairId = 'pair__id',
  PairInstitutionId = 'pair__institutionId',
  PairLastUpdated = 'pair__lastUpdated',
  PairRegisteredAt = 'pair__registeredAt',
  PairRegisteredAtBlock = 'pair__registeredAtBlock',
  Receipts = 'receipts',
  Rounds = 'rounds',
  UnderlyingToken = 'underlyingToken',
  UnderlyingTokenDecimals = 'underlyingToken__decimals',
  UnderlyingTokenId = 'underlyingToken__id',
  UnderlyingTokenLastPriceBlockNumber = 'underlyingToken__lastPriceBlockNumber',
  UnderlyingTokenLastPriceUsd = 'underlyingToken__lastPriceUSD',
...
export enum Vault_OrderBy {
  ...
  RoundsVaultPairActive = 'roundsVaultPair__active',
  RoundsVaultPairId = 'roundsVaultPair__id',
  RoundsVaultPairInstitutionId = 'roundsVaultPair__institutionId',
  RoundsVaultPairLastUpdated = 'roundsVaultPair__lastUpdated',
  RoundsVaultPairRegisteredAt = 'roundsVaultPair__registeredAt',
  RoundsVaultPairRegisteredAtBlock = 'roundsVaultPair__registeredAtBlock',
  StakedOutputTokenAmount = 'stakedOutputTokenAmount',
