...
export const GetUserPositionDocument = gql`
  ...
  positions(
    where: {account_contains_nocase: $accountAddress, vault_contains_nocase: $vaultId}
  ) {
    id
    inputTokenBalance
    outputTokenBalance
