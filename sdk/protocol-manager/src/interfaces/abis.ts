...
export const SPARK_LENDING_POOL_ABI = [
  {
    inputs: [
      { internalType: 'contract IPoolAddressesProvider', name: 'provider', type: 'address' },
    ],
...
// AAVE V3
export const AAVEV3_ORACLE_ABI = [
  {
    inputs: [
      { internalType: 'contract IPoolAddressesProvider', name: 'provider', type: 'address' },
      { internalType: 'address[]', name: 'assets', type: 'address[]' },
...
export const AAVEV3_LENDING_POOL_ABI = [
  {
    inputs: [
      { internalType: 'contract IPoolAddressesProvider', name: 'provider', type: 'address' },
    ],
...
export const AAVEV3_POOL_DATA_PROVIDER_ABI = [
  {
    inputs: [
      {
        internalType: 'contract IPoolAddressesProvider',
