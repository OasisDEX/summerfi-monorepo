...
export async function refinace(
    ...
    const simulation = await simulator
        ...
        .next(async () => ({
            ...
            skip: args.position.pool.collateralToken.address === args.targetPool.collateralToken.address,
        })).next(async (ctx) => ({
            name: 'DepositBorrow',
            ...
            skip: args.position.pool.debtToken.address === args.targetPool.debtToken.address,
        })).next(async () => ({
