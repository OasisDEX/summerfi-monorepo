    ...
    case ChainIds.Base:
      dataForChain = {
        ...
        '0x98c49e13bf99d7cad8069faa2a370933ec9ecf17': [
          getRewardDataForToken(chainId, 'SUMR', '18111'),
        ],
        // eurc low risk
        '0x64db8f51f1bf7064bb5a361a7265f602d348e0f0': [
          getRewardDataForToken(chainId, 'SUMR', '4590'),
        ],
        // eth low risk
        '0x2bb9ad69feba5547b7cd57aafe8457d40bf834af': [
          getRewardDataForToken(chainId, 'SUMR', '12453'),
        ],
      }
      break
    ...
    case ChainIds.ArbitrumOne:
      dataForChain = {
        ...
        '0x71d77c39db0eb5d086611a2e950198e3077cf58a': [
          getRewardDataForToken(chainId, 'SUMR', '4186'),
        ],
        // usdt low risk
        '0x98c49e13bf99d7cad8069faa2a370933ec9ecf17': [
          getRewardDataForToken(chainId, 'SUMR', '731'),
        ],
    ...
    case ChainIds.Mainnet:
      dataForChain = {
        ...
        '0x67e536797570b3d8919df052484273815a0ab506': [
          getRewardDataForToken(chainId, 'SUMR', '53373'),
        ],
        // eth high risk
        '0x2e6abcbcced9af05bc3b8a4908e0c98c29a88e10': [
          getRewardDataForToken(chainId, 'SUMR', '62274'),
        ],
        // usdc low risk
        '0x98c49e13bf99d7cad8069faa2a370933ec9ecf17': [
          getRewardDataForToken(chainId, 'SUMR', '69276'),
        ],
        // usdc high risk
        '0xe9cda459bed6dcfb8ac61cd8ce08e2d52370cb06': [
          getRewardDataForToken(chainId, 'SUMR', '22884'),
        ],
        // usdt low risk
        '0x17ee2d03e88b55e762c66c76ec99c3a28a54ad8d': [
          getRewardDataForToken(chainId, 'SUMR', '2934'),
        ],
        // usdc (DAO)
        '0xd77f9a9f2b0c160db3e9dc2cce370c1a740c76fc': [
          getRewardDataForToken(chainId, 'SUMR', '4850'),
        ],
        // eth (DAO)
    ...
    case ChainIds.Sonic:
      dataForChain = {
        ...
        '0x507a2d9e87dbd3076e65992049c41270b47964f8': [
          getRewardDataForToken(chainId, 'SUMR', '4225'),
        ],
      }
      break
    ...
    case ChainIds.Hyperliquid:
      dataForChain = {
        ...
        '0x252e5aa42c1804b85b2ce6712cd418a0561232ba': [
          getRewardDataForToken(chainId, 'SUMR', '5466'),
        ],
        // usdt
        '0x2cc190fb654141dfbeac4c0f718f4d511674d346': [
          getRewardDataForToken(chainId, 'SUMR', '2214'),
        ],
      }
      break
