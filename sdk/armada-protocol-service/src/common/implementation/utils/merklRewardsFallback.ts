  ...
  switch (chainId) {
    case ChainIds.Mainnet:
      return {
        ...
        '0x67e536797570b3d8919df052484273815a0ab506': [
          { token, dailyEmission: BigNumber('67611').shiftedBy(token.decimals).toFixed() },
        ],
        // eth high risk
        '0x2e6abcbcced9af05bc3b8a4908e0c98c29a88e10': [
          { token, dailyEmission: BigNumber('55556').shiftedBy(token.decimals).toFixed() },
        ],
        // usdc low risk
        ...
        '0xe9cda459bed6dcfb8ac61cd8ce08e2d52370cb06': [
          { token, dailyEmission: BigNumber('41667').shiftedBy(token.decimals).toFixed() },
        ],
        // usdt low risk
        '0x17ee2d03e88b55e762c66c76ec99c3a28a54ad8d': [
          { token, dailyEmission: BigNumber('34250').shiftedBy(token.decimals).toFixed() },
        ],
      }
    case ChainIds.Base:
      return {
        // usdc low risk
        '0x98c49e13bf99d7cad8069faa2a370933ec9ecf17': [
          { token, dailyEmission: BigNumber('18111').shiftedBy(token.decimals).toFixed() },
        ],
        // eurc low risk
        '0x64db8f51f1bf7064bb5a361a7265f602d348e0f0': [
          { token, dailyEmission: BigNumber('6000').shiftedBy(token.decimals).toFixed() },
        ],
        // eth low risk
    ...
    case ChainIds.ArbitrumOne:
      return {
        // usdt low risk
        '0x98c49e13bf99d7cad8069faa2a370933ec9ecf17': [
          { token, dailyEmission: BigNumber('17694').shiftedBy(token.decimals).toFixed() },
        ],
        // usdc low risk (new)
        '0x71d77c39db0eb5d086611a2e950198e3077cf58a': [
          { token, dailyEmission: BigNumber('16389').shiftedBy(token.decimals).toFixed() },
        ],
        // usdc low risk (hacked)
    ...
    case ChainIds.Sonic:
      return {
        ...
        '0x507a2d9e87dbd3076e65992049c41270b47964f8': [
          { token, dailyEmission: BigNumber('10041').shiftedBy(token.decimals).toFixed() },
        ],
      }
