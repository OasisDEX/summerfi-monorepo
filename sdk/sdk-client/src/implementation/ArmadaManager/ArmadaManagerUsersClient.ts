...
export class ArmadaManagerUsersClient extends IRPCClient implements IArmadaManagerUsersClient {
  ...
  async getCalculatePenaltyPercentage(
    params: Parameters<IArmadaManagerUsersClient['getCalculatePenaltyPercentage']>[0],
  ): ReturnType<IArmadaManagerUsersClient['getCalculatePenaltyPercentage']> {
    return this.rpcClient.armada.users.getCalculatePenaltyPercentage.query(params)
  }

  async getCalculatePenaltyAmount(
    params: Parameters<IArmadaManagerUsersClient['getCalculatePenaltyAmount']>[0],
  ): ReturnType<IArmadaManagerUsersClient['getCalculatePenaltyAmount']> {
    return this.rpcClient.armada.users.getCalculatePenaltyAmount.query(params)
  }
  ...
  async getVaultSwitchEnsoTx(
    params: Parameters<IArmadaManagerUsersClient['getVaultSwitchEnsoTx']>[0],
  ): ReturnType<IArmadaManagerUsersClient['getVaultSwitchEnsoTx']> {
    return this.rpcClient.armada.users.getVaultSwitchEnsoTx.query(params)
  }
  ...
  /** @see IArmadaManagerUsersClient.getVaultRewardsMerklClaimTx */
  async getVaultRewardsMerklClaimTx(
    params: Parameters<IArmadaManagerUsersClient['getVaultRewardsMerklClaimTx']>[0],
  ): ReturnType<IArmadaManagerUsersClient['getVaultRewardsMerklClaimTx']> {
    return this.rpcClient.armada.users.getVaultRewardsMerklClaimTx.query(params)
  }
  ...
  async getProtocolAddresses(
    ...
    // TODO: uncomment and remove below hardcoded addresses once the getProtocolAddresses endpoint is available on the RPC server
    // return this.rpcClient.armada.users.getProtocolAddresses.query(params)
