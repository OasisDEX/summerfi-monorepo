...
export class TokensManagerMock implements ITokensManager {
  private tokens: Record<string, Token> = {
    ...
    WBTC: Token.createFrom({
      chainInfo: ChainInfo.createFrom({ chainId: 1, name: 'Ethereum' }),
      address: Address.createFromEthereum({ value: '0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599' }),
      symbol: 'WBTC',
      name: 'Wrapped BTC',
      decimals: 8,
    }),
    GNO: Token.createFrom({
      chainInfo: ChainInfo.createFrom({ chainId: 1, name: 'Ethereum' }),
      address: Address.createFromEthereum({ value: '0x6810e776880C02933D47DB1b9fc05908e5386b96' }),
      symbol: 'GNO',
      name: 'Gnosis Token',
      decimals: 18,
    }),
    ...
    USDT: Token.createFrom({
      chainInfo: ChainInfo.createFrom({ chainId: 1, name: 'Ethereum' }),
      address: Address.createFromEthereum({ value: '0xdAC17F958D2ee523a2206206994597C13D831ec7' }),
      symbol: 'USDT',
