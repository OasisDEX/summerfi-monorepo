...
import {
  ...
  yieldsRawData,
} from '@/features/strategy-details/components/StrategyDetailsAdvancedYield/config'
import { individualYieldsMapper } from '@/features/strategy-details/components/StrategyDetailsAdvancedYield/mapper'
import { individualYieldsColumns } from '@/features/strategy-details/components/StrategyDetailsYields/columns'

export const StrategyDetailsAdvancedYield = () => {
