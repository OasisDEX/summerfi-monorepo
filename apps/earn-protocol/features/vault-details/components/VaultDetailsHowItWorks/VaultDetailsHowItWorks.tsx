...
import {
  vaultDetailsHowItWorksLinks,
  vaultDetailsHowItWorksOptions,
} from '@/features/vault-details/components/VaultDetailsHowItWorks/config'
...
export const VaultDetailsHowItWorks = () => {
  const [currentOption, setCurrentOption] = useState<InlineButtonOption<string>>(
    vaultDetailsHowItWorksOptions[0],
  )
  ...
  return (
    <Card variant="cardSecondary">
      ...
      >
        ...
        <InlineButtons
          options={vaultDetailsHowItWorksOptions}
