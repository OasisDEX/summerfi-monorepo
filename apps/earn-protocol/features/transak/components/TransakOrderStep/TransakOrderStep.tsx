...
import { transakFailedOrderStatuses, transakPendingOrderStatuses } from '@/features/transak/consts'
...
export const TransakOrderStep: FC<TransakOrderStepProps> = ({ orderData }) => {
  const resolvedIcon = {
    ...
    [TransakOrderDataStatus.PENDING_DELIVERY_FROM_TRANSAK]: { icon: 'checkmark_colorful' },
  ...
  return (
    <div className={classNames.wrapper}>
      ...
      >
        {(!orderData || transakPendingOrderStatuses.includes(orderData.data.status)) &&
