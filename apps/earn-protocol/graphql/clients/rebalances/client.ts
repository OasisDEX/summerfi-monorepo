...
export type GetRebalancesQuery = { __typename?: 'Query', rebalances: Array<{ __typename?: 'Rebalance', id: string, amount: number, amountUSD: number, timestamp: number, hash: string, from: { __typename?: 'Ark', name?: string | null, depositLimit: number, totalValueLockedUSD: number }, to: { __typename?: 'Ark', name?: string | null, depositLimit: number, totalValueLockedUSD: number }, fromPostAction: { __typename?: 'PostActionArkSnapshot', depositLimit: number }, toPostAction: { __typename?: 'PostActionArkSnapshot', depositLimit: number }, vault: { __typename?: 'Vault', id: string, name?: string | null, inputTokenPriceUSD?: number | null, inputToken: { __typename?: 'Token', id: string, symbol: string, decimals: number }, protocol: { __typename?: 'YieldAggregator', network: Network } } }> };


export const GetRebalancesDocument = /*#__PURE__*/ gql`
