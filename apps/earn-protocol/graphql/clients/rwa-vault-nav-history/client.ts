...
export type GetRwaVaultNavHistoryQueryVariables = Exact<{
  vaultId: Scalars['ID']['input'];
}>;


export type GetRwaVaultNavHistoryQuery = { __typename?: 'Query', vault?: { __typename?: 'Vault', id: string, hourlyVaultHistory: Array<{ __typename?: 'VaultHourlySnapshot', timestamp: number, navPrice?: number | null }>, dailyVaultHistory: Array<{ __typename?: 'VaultDailySnapshot', timestamp: number, navPrice?: number | null }>, weeklyVaultHistory: Array<{ __typename?: 'VaultWeeklySnapshot', timestamp: number, navPrice?: number | null }> } | null };


export const GetRwaVaultNavHistoryDocument = /*#__PURE__*/ gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetRwaVaultNavHistory(variables: GetRwaVaultNavHistoryQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetRwaVaultNavHistoryQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetRwaVaultNavHistoryQuery>({ document: GetRwaVaultNavHistoryDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetRwaVaultNavHistory', 'query', variables);
    }
  };
}
