...
export type GetRebalancesQuery = { __typename?: 'Query', rebalances: Array<{ __typename?: 'Rebalance', id: string, amount: number, amountUSD: number, timestamp: number, from: { __typename?: 'Ark', name?: string | null, depositLimit: number, totalValueLockedUSD: number }, to: { __typename?: 'Ark', name?: string | null, depositLimit: number, totalValueLockedUSD: number }, vault: { __typename?: 'Vault', id: string, name?: string | null, inputTokenPriceUSD?: number | null, inputToken: { __typename?: 'Token', id: string, symbol: string, decimals: number }, protocol: { __typename?: 'YieldAggregator', network: Network } } }> };
