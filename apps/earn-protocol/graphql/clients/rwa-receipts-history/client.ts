...
export type AccessController = {
  __typename?: 'AccessController';
  id: Scalars['ID']['output'];
  institution: Institution;
};

export type AccessController_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<AccessController_Filter>>>;
  ...
  or?: InputMaybe<Array<InputMaybe<AccessController_Filter>>>;
};

export enum AccessController_OrderBy {
  id = 'id',
  institution = 'institution',
  institution__active = 'institution__active',
  institution__admiralsQuarters = 'institution__admiralsQuarters',
  institution__configurationManager = 'institution__configurationManager',
  institution__createdBlockNumber = 'institution__createdBlockNumber',
  institution__createdTimestamp = 'institution__createdTimestamp',
  institution__harborCommand = 'institution__harborCommand',
  institution__id = 'institution__id',
  institution__protocolAccessManager = 'institution__protocolAccessManager'
}
...
export type Account = {
  ...
  /**  Rounds-vault receipts held by this account  */
  roundsVaultReceipts: Array<Receipt>;
...
export type AccountRoundsVaultReceiptsArgs = {
  first?: InputMaybe<Scalars['Int']['input']>;
...
export type Account_Filter = {
  ...
  roundsVaultReceipts_?: InputMaybe<Receipt_Filter>;
...
export enum Account_OrderBy {
  ...
  rewards = 'rewards',
  roundsVaultReceipts = 'roundsVaultReceipts',
...
export enum AdminAction {
  ARK_CAP_CHANGED = 'ARK_CAP_CHANGED',
  ARK_MAX_PCT_TVL_CHANGED = 'ARK_MAX_PCT_TVL_CHANGED',
  ARK_MAX_REBALANCE_INFLOW_CHANGED = 'ARK_MAX_REBALANCE_INFLOW_CHANGED',
  ARK_MAX_REBALANCE_OUTFLOW_CHANGED = 'ARK_MAX_REBALANCE_OUTFLOW_CHANGED',
  VAULT_CAP_CHANGED = 'VAULT_CAP_CHANGED',
  VAULT_MIN_BUFFER_CHANGED = 'VAULT_MIN_BUFFER_CHANGED',
  VAULT_TIP_RATE_CHANGED = 'VAULT_TIP_RATE_CHANGED'
}
...
export enum ArkDailySnapshot_OrderBy {
  ...
  protocol = 'protocol',
  protocol___hourlySnapshotsDeepCleaned = 'protocol___hourlySnapshotsDeepCleaned',
  ...
  vault__isWhitelistOpen = 'vault__isWhitelistOpen',
...
export type Institution = {
  ...
  admiralsQuarters: Scalars['String']['output'];
  configurationManager: Scalars['String']['output'];
  createdBlockNumber: Scalars['BigInt']['output'];
  createdTimestamp: Scalars['BigInt']['output'];
...
export type InstitutionVaultsArgs = {
  first?: InputMaybe<Scalars['Int']['input']>;
...
export type Institution_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  ...
  admiralsQuarters?: InputMaybe<Scalars['String']['input']>;
  admiralsQuarters_contains?: InputMaybe<Scalars['String']['input']>;
  admiralsQuarters_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  admiralsQuarters_ends_with?: InputMaybe<Scalars['String']['input']>;
  admiralsQuarters_ends_with_nocase?: InputMaybe<Scalars['String']['input']>;
  admiralsQuarters_gt?: InputMaybe<Scalars['String']['input']>;
  admiralsQuarters_gte?: InputMaybe<Scalars['String']['input']>;
  admiralsQuarters_in?: InputMaybe<Array<Scalars['String']['input']>>;
  admiralsQuarters_lt?: InputMaybe<Scalars['String']['input']>;
  admiralsQuarters_lte?: InputMaybe<Scalars['String']['input']>;
  admiralsQuarters_not?: InputMaybe<Scalars['String']['input']>;
  admiralsQuarters_not_contains?: InputMaybe<Scalars['String']['input']>;
  admiralsQuarters_not_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  admiralsQuarters_not_ends_with?: InputMaybe<Scalars['String']['input']>;
  admiralsQuarters_not_ends_with_nocase?: InputMaybe<Scalars['String']['input']>;
  admiralsQuarters_not_in?: InputMaybe<Array<Scalars['String']['input']>>;
  admiralsQuarters_not_starts_with?: InputMaybe<Scalars['String']['input']>;
  admiralsQuarters_not_starts_with_nocase?: InputMaybe<Scalars['String']['input']>;
  admiralsQuarters_starts_with?: InputMaybe<Scalars['String']['input']>;
  admiralsQuarters_starts_with_nocase?: InputMaybe<Scalars['String']['input']>;
  and?: InputMaybe<Array<InputMaybe<Institution_Filter>>>;
  configurationManager?: InputMaybe<Scalars['String']['input']>;
  configurationManager_contains?: InputMaybe<Scalars['String']['input']>;
  configurationManager_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  configurationManager_ends_with?: InputMaybe<Scalars['String']['input']>;
  configurationManager_ends_with_nocase?: InputMaybe<Scalars['String']['input']>;
  configurationManager_gt?: InputMaybe<Scalars['String']['input']>;
  configurationManager_gte?: InputMaybe<Scalars['String']['input']>;
  configurationManager_in?: InputMaybe<Array<Scalars['String']['input']>>;
  configurationManager_lt?: InputMaybe<Scalars['String']['input']>;
  configurationManager_lte?: InputMaybe<Scalars['String']['input']>;
  configurationManager_not?: InputMaybe<Scalars['String']['input']>;
  configurationManager_not_contains?: InputMaybe<Scalars['String']['input']>;
  configurationManager_not_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  configurationManager_not_ends_with?: InputMaybe<Scalars['String']['input']>;
  configurationManager_not_ends_with_nocase?: InputMaybe<Scalars['String']['input']>;
  configurationManager_not_in?: InputMaybe<Array<Scalars['String']['input']>>;
  configurationManager_not_starts_with?: InputMaybe<Scalars['String']['input']>;
  configurationManager_not_starts_with_nocase?: InputMaybe<Scalars['String']['input']>;
  configurationManager_starts_with?: InputMaybe<Scalars['String']['input']>;
  configurationManager_starts_with_nocase?: InputMaybe<Scalars['String']['input']>;
  createdBlockNumber?: InputMaybe<Scalars['BigInt']['input']>;
  createdBlockNumber_gt?: InputMaybe<Scalars['BigInt']['input']>;
  createdBlockNumber_gte?: InputMaybe<Scalars['BigInt']['input']>;
  createdBlockNumber_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
  ...
  createdTimestamp_not?: InputMaybe<Scalars['BigInt']['input']>;
  createdTimestamp_not_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
  harborCommand?: InputMaybe<Scalars['String']['input']>;
  harborCommand_contains?: InputMaybe<Scalars['String']['input']>;
  harborCommand_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  harborCommand_ends_with?: InputMaybe<Scalars['String']['input']>;
  harborCommand_ends_with_nocase?: InputMaybe<Scalars['String']['input']>;
  harborCommand_gt?: InputMaybe<Scalars['String']['input']>;
  harborCommand_gte?: InputMaybe<Scalars['String']['input']>;
  harborCommand_in?: InputMaybe<Array<Scalars['String']['input']>>;
  harborCommand_lt?: InputMaybe<Scalars['String']['input']>;
  harborCommand_lte?: InputMaybe<Scalars['String']['input']>;
  harborCommand_not?: InputMaybe<Scalars['String']['input']>;
  harborCommand_not_contains?: InputMaybe<Scalars['String']['input']>;
  harborCommand_not_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  harborCommand_not_ends_with?: InputMaybe<Scalars['String']['input']>;
  harborCommand_not_ends_with_nocase?: InputMaybe<Scalars['String']['input']>;
  harborCommand_not_in?: InputMaybe<Array<Scalars['String']['input']>>;
  harborCommand_not_starts_with?: InputMaybe<Scalars['String']['input']>;
  harborCommand_not_starts_with_nocase?: InputMaybe<Scalars['String']['input']>;
  harborCommand_starts_with?: InputMaybe<Scalars['String']['input']>;
  harborCommand_starts_with_nocase?: InputMaybe<Scalars['String']['input']>;
  id?: InputMaybe<Scalars['ID']['input']>;
  id_gt?: InputMaybe<Scalars['ID']['input']>;
  id_gte?: InputMaybe<Scalars['ID']['input']>;
  id_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  or?: InputMaybe<Array<InputMaybe<Institution_Filter>>>;
  protocolAccessManager?: InputMaybe<Scalars['String']['input']>;
  protocolAccessManager_contains?: InputMaybe<Scalars['String']['input']>;
  protocolAccessManager_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  protocolAccessManager_ends_with?: InputMaybe<Scalars['String']['input']>;
  protocolAccessManager_ends_with_nocase?: InputMaybe<Scalars['String']['input']>;
  protocolAccessManager_gt?: InputMaybe<Scalars['String']['input']>;
  protocolAccessManager_gte?: InputMaybe<Scalars['String']['input']>;
  protocolAccessManager_in?: InputMaybe<Array<Scalars['String']['input']>>;
  protocolAccessManager_lt?: InputMaybe<Scalars['String']['input']>;
  protocolAccessManager_lte?: InputMaybe<Scalars['String']['input']>;
  protocolAccessManager_not?: InputMaybe<Scalars['String']['input']>;
  protocolAccessManager_not_contains?: InputMaybe<Scalars['String']['input']>;
  protocolAccessManager_not_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  protocolAccessManager_not_ends_with?: InputMaybe<Scalars['String']['input']>;
  protocolAccessManager_not_ends_with_nocase?: InputMaybe<Scalars['String']['input']>;
  protocolAccessManager_not_in?: InputMaybe<Array<Scalars['String']['input']>>;
  protocolAccessManager_not_starts_with?: InputMaybe<Scalars['String']['input']>;
...
export enum Institution_OrderBy {
  active = 'active',
...
export type Query = {
  ...
  _meta?: Maybe<_Meta_>;
  accessController?: Maybe<AccessController>;
  accessControllers: Array<AccessController>;
  ...
  round?: Maybe<Round>;
  rounds: Array<Round>;
  roundsVault?: Maybe<RoundsVault>;
  roundsVaultPair?: Maybe<RoundsVaultPair>;
  roundsVaultPairs: Array<RoundsVaultPair>;
  roundsVaults: Array<RoundsVault>;
  staked?: Maybe<Staked>;
...
export type QueryAccessControllerArgs = {
  block?: InputMaybe<Block_Height>;
  id: Scalars['ID']['input'];
...
export type QueryAccessControllersArgs = {
  block?: InputMaybe<Block_Height>;
  first?: InputMaybe<Scalars['Int']['input']>;
  orderBy?: InputMaybe<AccessController_OrderBy>;
  orderDirection?: InputMaybe<OrderDirection>;
  skip?: InputMaybe<Scalars['Int']['input']>;
  subgraphError?: _SubgraphErrorPolicy_;
  where?: InputMaybe<AccessController_Filter>;
};
...
export type QueryInstitutionsArgs = {
  block?: InputMaybe<Block_Height>;
  first?: InputMaybe<Scalars['Int']['input']>;
  orderBy?: InputMaybe<Institution_OrderBy>;
  orderDirection?: InputMaybe<OrderDirection>;
  skip?: InputMaybe<Scalars['Int']['input']>;
  subgraphError?: _SubgraphErrorPolicy_;
  where?: InputMaybe<Institution_Filter>;
};
...
export type QueryRoundsVaultArgs = {
  block?: InputMaybe<Block_Height>;
  id: Scalars['ID']['input'];
  subgraphError?: _SubgraphErrorPolicy_;
};
...
export type QueryRoundsVaultPairArgs = {
  block?: InputMaybe<Block_Height>;
  id: Scalars['ID']['input'];
  subgraphError?: _SubgraphErrorPolicy_;
};
...
export type QueryRoundsVaultPairsArgs = {
  block?: InputMaybe<Block_Height>;
  first?: InputMaybe<Scalars['Int']['input']>;
  orderBy?: InputMaybe<RoundsVaultPair_OrderBy>;
  orderDirection?: InputMaybe<OrderDirection>;
  skip?: InputMaybe<Scalars['Int']['input']>;
  subgraphError?: _SubgraphErrorPolicy_;
  where?: InputMaybe<RoundsVaultPair_Filter>;
};


export type QueryRoundsVaultsArgs = {
  block?: InputMaybe<Block_Height>;
  first?: InputMaybe<Scalars['Int']['input']>;
  orderBy?: InputMaybe<RoundsVault_OrderBy>;
  orderDirection?: InputMaybe<OrderDirection>;
  skip?: InputMaybe<Scalars['Int']['input']>;
  subgraphError?: _SubgraphErrorPolicy_;
  where?: InputMaybe<RoundsVault_Filter>;
};
...
export enum ReceiptActivity_OrderBy {
  ...
  assetToken__decimals = 'assetToken__decimals',
  assetToken__id = 'assetToken__id',
  assetToken__lastPriceBlockNumber = 'assetToken__lastPriceBlockNumber',
  assetToken__lastPriceUSD = 'assetToken__lastPriceUSD',
  assetToken__name = 'assetToken__name',
  assetToken__symbol = 'assetToken__symbol',
  blockNumber = 'blockNumber',
  caller = 'caller',
  id = 'id',
  receipt = 'receipt',
  receiptAmount = 'receiptAmount',
  receipt__balance = 'receipt__balance',
  receipt__id = 'receipt__id',
  receipt__lastUpdated = 'receipt__lastUpdated',
  receipt__lastUpdatedBlock = 'receipt__lastUpdatedBlock',
  receiver = 'receiver',
  round = 'round',
  roundStateAtAction = 'roundStateAtAction',
  round__closedAt = 'round__closedAt',
  round__closedAtBlock = 'round__closedAtBlock',
  round__exchangeRateBase = 'round__exchangeRateBase',
  round__exchangeRateQuote = 'round__exchangeRateQuote',
  round__id = 'round__id',
  round__isEmpty = 'round__isEmpty',
  round__openedAt = 'round__openedAt',
  round__openedAtBlock = 'round__openedAtBlock',
  round__receiptSupply = 'round__receiptSupply',
  round__rolledBack = 'round__rolledBack',
  round__roundId = 'round__roundId',
  round__settledAt = 'round__settledAt',
  round__settledAtBlock = 'round__settledAtBlock',
  round__state = 'round__state',
  timestamp = 'timestamp',
  txHash = 'txHash',
  type = 'type',
  vault = 'vault',
  vault__createdAt = 'vault__createdAt',
  vault__createdAtBlock = 'vault__createdAtBlock',
  vault__currentRound = 'vault__currentRound',
  vault__flavor = 'vault__flavor',
  vault__id = 'vault__id',
  vault__minPositionSize = 'vault__minPositionSize'
}
...
export enum RoleEvent_OrderBy {
  ...
  logIndex = 'logIndex',
  role = 'role',
  role__accessController = 'role__accessController',
  role__active = 'role__active',
  role__createdBlockNumber = 'role__createdBlockNumber',
  role__createdTimestamp = 'role__createdTimestamp',
  role__id = 'role__id',
  role__name = 'role__name',
  role__owner = 'role__owner',
  role__targetContract = 'role__targetContract',
  timestamp = 'timestamp'
}
...
export type Role_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  accessController?: InputMaybe<Scalars['String']['input']>;
  accessController_contains?: InputMaybe<Scalars['String']['input']>;
  accessController_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  accessController_ends_with?: InputMaybe<Scalars['String']['input']>;
  accessController_ends_with_nocase?: InputMaybe<Scalars['String']['input']>;
  accessController_gt?: InputMaybe<Scalars['String']['input']>;
  accessController_gte?: InputMaybe<Scalars['String']['input']>;
  accessController_in?: InputMaybe<Array<Scalars['String']['input']>>;
  accessController_lt?: InputMaybe<Scalars['String']['input']>;
  accessController_lte?: InputMaybe<Scalars['String']['input']>;
  accessController_not?: InputMaybe<Scalars['String']['input']>;
  accessController_not_contains?: InputMaybe<Scalars['String']['input']>;
  accessController_not_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  accessController_not_ends_with?: InputMaybe<Scalars['String']['input']>;
  accessController_not_ends_with_nocase?: InputMaybe<Scalars['String']['input']>;
  accessController_not_in?: InputMaybe<Array<Scalars['String']['input']>>;
  accessController_not_starts_with?: InputMaybe<Scalars['String']['input']>;
...
export type Round_Filter = {
  ...
  closedAtBlock_gt?: InputMaybe<Scalars['BigInt']['input']>;
  closedAtBlock_gte?: InputMaybe<Scalars['BigInt']['input']>;
  closedAtBlock_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
  closedAtBlock_lt?: InputMaybe<Scalars['BigInt']['input']>;
  closedAtBlock_lte?: InputMaybe<Scalars['BigInt']['input']>;
  closedAtBlock_not?: InputMaybe<Scalars['BigInt']['input']>;
  closedAtBlock_not_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
  ...
  exchangeRateBase_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
  exchangeRateBase_lt?: InputMaybe<Scalars['BigInt']['input']>;
  ...
  exchangeRateQuote_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
  exchangeRateQuote_lt?: InputMaybe<Scalars['BigInt']['input']>;
  exchangeRateQuote_lte?: InputMaybe<Scalars['BigInt']['input']>;
  exchangeRateQuote_not?: InputMaybe<Scalars['BigInt']['input']>;
  exchangeRateQuote_not_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
  id?: InputMaybe<Scalars['ID']['input']>;
  id_gt?: InputMaybe<Scalars['ID']['input']>;
  id_gte?: InputMaybe<Scalars['ID']['input']>;
  id_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  ...
  openedAtBlock_gte?: InputMaybe<Scalars['BigInt']['input']>;
  openedAtBlock_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
  openedAtBlock_lt?: InputMaybe<Scalars['BigInt']['input']>;
  openedAtBlock_lte?: InputMaybe<Scalars['BigInt']['input']>;
  openedAtBlock_not?: InputMaybe<Scalars['BigInt']['input']>;
  openedAtBlock_not_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
  ...
  receiptSupply?: InputMaybe<Scalars['BigInt']['input']>;
  receiptSupply_gt?: InputMaybe<Scalars['BigInt']['input']>;
  receiptSupply_gte?: InputMaybe<Scalars['BigInt']['input']>;
  receiptSupply_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
  receiptSupply_lt?: InputMaybe<Scalars['BigInt']['input']>;
  receiptSupply_lte?: InputMaybe<Scalars['BigInt']['input']>;
  ...
  rolledBack_not_in?: InputMaybe<Array<Scalars['Boolean']['input']>>;
  ...
  settledAtBlock?: InputMaybe<Scalars['BigInt']['input']>;
  settledAtBlock_gt?: InputMaybe<Scalars['BigInt']['input']>;
  settledAtBlock_gte?: InputMaybe<Scalars['BigInt']['input']>;
  settledAtBlock_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
  settledAtBlock_lt?: InputMaybe<Scalars['BigInt']['input']>;
  settledAtBlock_lte?: InputMaybe<Scalars['BigInt']['input']>;
  settledAtBlock_not?: InputMaybe<Scalars['BigInt']['input']>;
  settledAtBlock_not_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
...
export type RoundsVault = {
  __typename?: 'RoundsVault';
  createdAt: Scalars['BigInt']['output'];
  createdAtBlock: Scalars['BigInt']['output'];
  currentRound: Scalars['BigInt']['output'];
  /**  Token returned at settlement (INPUT: target shares; OUTPUT: target.asset())  */
  exchangeAssetToken: Token;
  flavor: RoundsVaultFlavor;
  /**  RoundsVault contract address  */
  id: Scalars['ID']['output'];
  minPositionSize: Scalars['BigInt']['output'];
  pair: RoundsVaultPair;
  receipts: Array<Receipt>;
  rounds: Array<Round>;
  /**  Token deposited by users (INPUT: target.asset(); OUTPUT: target shares)  */
  underlyingToken: Token;
};


export type RoundsVaultReceiptsArgs = {
  first?: InputMaybe<Scalars['Int']['input']>;
  orderBy?: InputMaybe<Receipt_OrderBy>;
  orderDirection?: InputMaybe<OrderDirection>;
  skip?: InputMaybe<Scalars['Int']['input']>;
...
export type RoundsVaultRoundsArgs = {
  first?: InputMaybe<Scalars['Int']['input']>;
  orderBy?: InputMaybe<Round_OrderBy>;
  orderDirection?: InputMaybe<OrderDirection>;
  skip?: InputMaybe<Scalars['Int']['input']>;
...
export enum RoundsVaultFlavor {
  INPUT = 'INPUT',
  OUTPUT = 'OUTPUT'
}

export type RoundsVaultPair = {
  __typename?: 'RoundsVaultPair';
  active: Scalars['Boolean']['output'];
  /**  keccak256(targetVault) — pairId from RoundsVaultRegistry  */
  id: Scalars['ID']['output'];
  inputVault?: Maybe<RoundsVault>;
  institutionId: Scalars['String']['output'];
  lastUpdated: Scalars['BigInt']['output'];
  outputVault?: Maybe<RoundsVault>;
  registeredAt: Scalars['BigInt']['output'];
  registeredAtBlock: Scalars['BigInt']['output'];
  /**  The FleetCommander Vault entity wrapped by this rounds-vault pair  */
  targetVault: Vault;
};

export type RoundsVaultPair_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  active?: InputMaybe<Scalars['Boolean']['input']>;
  active_in?: InputMaybe<Array<Scalars['Boolean']['input']>>;
  active_not?: InputMaybe<Scalars['Boolean']['input']>;
  active_not_in?: InputMaybe<Array<Scalars['Boolean']['input']>>;
  and?: InputMaybe<Array<InputMaybe<RoundsVaultPair_Filter>>>;
  id?: InputMaybe<Scalars['ID']['input']>;
  id_gt?: InputMaybe<Scalars['ID']['input']>;
  id_gte?: InputMaybe<Scalars['ID']['input']>;
  id_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  inputVault?: InputMaybe<Scalars['String']['input']>;
  inputVault_?: InputMaybe<RoundsVault_Filter>;
  inputVault_contains?: InputMaybe<Scalars['String']['input']>;
  inputVault_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  inputVault_ends_with?: InputMaybe<Scalars['String']['input']>;
  inputVault_ends_with_nocase?: InputMaybe<Scalars['String']['input']>;
  inputVault_gt?: InputMaybe<Scalars['String']['input']>;
  inputVault_gte?: InputMaybe<Scalars['String']['input']>;
  inputVault_in?: InputMaybe<Array<Scalars['String']['input']>>;
  inputVault_lt?: InputMaybe<Scalars['String']['input']>;
  inputVault_lte?: InputMaybe<Scalars['String']['input']>;
  inputVault_not?: InputMaybe<Scalars['String']['input']>;
  inputVault_not_contains?: InputMaybe<Scalars['String']['input']>;
  inputVault_not_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  inputVault_not_ends_with?: InputMaybe<Scalars['String']['input']>;
  inputVault_not_ends_with_nocase?: InputMaybe<Scalars['String']['input']>;
  inputVault_not_in?: InputMaybe<Array<Scalars['String']['input']>>;
  inputVault_not_starts_with?: InputMaybe<Scalars['String']['input']>;
  inputVault_not_starts_with_nocase?: InputMaybe<Scalars['String']['input']>;
  inputVault_starts_with?: InputMaybe<Scalars['String']['input']>;
  inputVault_starts_with_nocase?: InputMaybe<Scalars['String']['input']>;
  institutionId?: InputMaybe<Scalars['String']['input']>;
  institutionId_contains?: InputMaybe<Scalars['String']['input']>;
  institutionId_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  institutionId_ends_with?: InputMaybe<Scalars['String']['input']>;
  institutionId_ends_with_nocase?: InputMaybe<Scalars['String']['input']>;
  institutionId_gt?: InputMaybe<Scalars['String']['input']>;
  institutionId_gte?: InputMaybe<Scalars['String']['input']>;
  institutionId_in?: InputMaybe<Array<Scalars['String']['input']>>;
  institutionId_lt?: InputMaybe<Scalars['String']['input']>;
  institutionId_lte?: InputMaybe<Scalars['String']['input']>;
  institutionId_not?: InputMaybe<Scalars['String']['input']>;
  institutionId_not_contains?: InputMaybe<Scalars['String']['input']>;
  institutionId_not_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  institutionId_not_ends_with?: InputMaybe<Scalars['String']['input']>;
  institutionId_not_ends_with_nocase?: InputMaybe<Scalars['String']['input']>;
  institutionId_not_in?: InputMaybe<Array<Scalars['String']['input']>>;
  institutionId_not_starts_with?: InputMaybe<Scalars['String']['input']>;
  institutionId_not_starts_with_nocase?: InputMaybe<Scalars['String']['input']>;
  institutionId_starts_with?: InputMaybe<Scalars['String']['input']>;
  institutionId_starts_with_nocase?: InputMaybe<Scalars['String']['input']>;
  lastUpdated?: InputMaybe<Scalars['BigInt']['input']>;
  lastUpdated_gt?: InputMaybe<Scalars['BigInt']['input']>;
  lastUpdated_gte?: InputMaybe<Scalars['BigInt']['input']>;
  lastUpdated_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
  ...
  lastUpdated_not?: InputMaybe<Scalars['BigInt']['input']>;
  lastUpdated_not_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
  or?: InputMaybe<Array<InputMaybe<RoundsVaultPair_Filter>>>;
  outputVault?: InputMaybe<Scalars['String']['input']>;
  outputVault_?: InputMaybe<RoundsVault_Filter>;
  outputVault_contains?: InputMaybe<Scalars['String']['input']>;
  outputVault_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  outputVault_ends_with?: InputMaybe<Scalars['String']['input']>;
  outputVault_ends_with_nocase?: InputMaybe<Scalars['String']['input']>;
  outputVault_gt?: InputMaybe<Scalars['String']['input']>;
  outputVault_gte?: InputMaybe<Scalars['String']['input']>;
  outputVault_in?: InputMaybe<Array<Scalars['String']['input']>>;
  outputVault_lt?: InputMaybe<Scalars['String']['input']>;
  outputVault_lte?: InputMaybe<Scalars['String']['input']>;
  outputVault_not?: InputMaybe<Scalars['String']['input']>;
  outputVault_not_contains?: InputMaybe<Scalars['String']['input']>;
  outputVault_not_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  outputVault_not_ends_with?: InputMaybe<Scalars['String']['input']>;
  outputVault_not_ends_with_nocase?: InputMaybe<Scalars['String']['input']>;
  outputVault_not_in?: InputMaybe<Array<Scalars['String']['input']>>;
  outputVault_not_starts_with?: InputMaybe<Scalars['String']['input']>;
  outputVault_not_starts_with_nocase?: InputMaybe<Scalars['String']['input']>;
  outputVault_starts_with?: InputMaybe<Scalars['String']['input']>;
  outputVault_starts_with_nocase?: InputMaybe<Scalars['String']['input']>;
  ...
  targetVault?: InputMaybe<Scalars['String']['input']>;
  targetVault_?: InputMaybe<Vault_Filter>;
  targetVault_contains?: InputMaybe<Scalars['String']['input']>;
  targetVault_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  targetVault_ends_with?: InputMaybe<Scalars['String']['input']>;
  targetVault_ends_with_nocase?: InputMaybe<Scalars['String']['input']>;
  targetVault_gt?: InputMaybe<Scalars['String']['input']>;
  targetVault_gte?: InputMaybe<Scalars['String']['input']>;
  targetVault_in?: InputMaybe<Array<Scalars['String']['input']>>;
  targetVault_lt?: InputMaybe<Scalars['String']['input']>;
  targetVault_lte?: InputMaybe<Scalars['String']['input']>;
  targetVault_not?: InputMaybe<Scalars['String']['input']>;
  targetVault_not_contains?: InputMaybe<Scalars['String']['input']>;
  targetVault_not_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  targetVault_not_ends_with?: InputMaybe<Scalars['String']['input']>;
  targetVault_not_ends_with_nocase?: InputMaybe<Scalars['String']['input']>;
  targetVault_not_in?: InputMaybe<Array<Scalars['String']['input']>>;
  targetVault_not_starts_with?: InputMaybe<Scalars['String']['input']>;
  targetVault_not_starts_with_nocase?: InputMaybe<Scalars['String']['input']>;
  targetVault_starts_with?: InputMaybe<Scalars['String']['input']>;
  targetVault_starts_with_nocase?: InputMaybe<Scalars['String']['input']>;
};

export enum RoundsVaultPair_OrderBy {
  active = 'active',
  id = 'id',
  inputVault = 'inputVault',
  inputVault__createdAt = 'inputVault__createdAt',
  inputVault__createdAtBlock = 'inputVault__createdAtBlock',
  inputVault__currentRound = 'inputVault__currentRound',
  inputVault__flavor = 'inputVault__flavor',
  inputVault__id = 'inputVault__id',
  inputVault__minPositionSize = 'inputVault__minPositionSize',
  institutionId = 'institutionId',
  lastUpdated = 'lastUpdated',
  outputVault = 'outputVault',
  outputVault__createdAt = 'outputVault__createdAt',
  outputVault__createdAtBlock = 'outputVault__createdAtBlock',
  outputVault__currentRound = 'outputVault__currentRound',
  outputVault__flavor = 'outputVault__flavor',
  outputVault__id = 'outputVault__id',
  outputVault__minPositionSize = 'outputVault__minPositionSize',
  registeredAt = 'registeredAt',
  registeredAtBlock = 'registeredAtBlock',
  targetVault = 'targetVault',
  targetVault__apr7d = 'targetVault__apr7d',
  targetVault__apr30d = 'targetVault__apr30d',
  targetVault__apr90d = 'targetVault__apr90d',
  targetVault__apr180d = 'targetVault__apr180d',
  targetVault__apr365d = 'targetVault__apr365d',
  targetVault__calculatedApr = 'targetVault__calculatedApr',
  targetVault__createdBlockNumber = 'targetVault__createdBlockNumber',
  targetVault__createdTimestamp = 'targetVault__createdTimestamp',
  targetVault__cumulativeProtocolSideRevenueUSD = 'targetVault__cumulativeProtocolSideRevenueUSD',
  targetVault__cumulativeSupplySideRevenueUSD = 'targetVault__cumulativeSupplySideRevenueUSD',
  targetVault__cumulativeTotalRevenueUSD = 'targetVault__cumulativeTotalRevenueUSD',
  targetVault__depositCap = 'targetVault__depositCap',
  targetVault__depositLimit = 'targetVault__depositLimit',
  targetVault__details = 'targetVault__details',
  targetVault__id = 'targetVault__id',
  targetVault__inputTokenBalance = 'targetVault__inputTokenBalance',
  targetVault__inputTokenPriceUSD = 'targetVault__inputTokenPriceUSD',
  targetVault__isWhitelistOpen = 'targetVault__isWhitelistOpen',
  targetVault__lastUpdatePricePerShare = 'targetVault__lastUpdatePricePerShare',
  targetVault__lastUpdateTimestamp = 'targetVault__lastUpdateTimestamp',
  targetVault__maxRebalanceOperations = 'targetVault__maxRebalanceOperations',
  targetVault__minimumBufferBalance = 'targetVault__minimumBufferBalance',
  targetVault__name = 'targetVault__name',
  targetVault__outputTokenPriceUSD = 'targetVault__outputTokenPriceUSD',
  targetVault__outputTokenSupply = 'targetVault__outputTokenSupply',
  targetVault__pricePerShare = 'targetVault__pricePerShare',
  targetVault__rebalanceCount = 'targetVault__rebalanceCount',
  targetVault__stakedOutputTokenAmount = 'targetVault__stakedOutputTokenAmount',
  targetVault__stakingRewardsManager = 'targetVault__stakingRewardsManager',
  targetVault__symbol = 'targetVault__symbol',
  targetVault__tipRate = 'targetVault__tipRate',
  targetVault__totalValueLockedUSD = 'targetVault__totalValueLockedUSD',
  targetVault__withdrawableTotalAssets = 'targetVault__withdrawableTotalAssets',
  targetVault__withdrawableTotalAssetsUSD = 'targetVault__withdrawableTotalAssetsUSD'
}

export type RoundsVault_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<RoundsVault_Filter>>>;
  ...
  currentRound_gt?: InputMaybe<Scalars['BigInt']['input']>;
  currentRound_gte?: InputMaybe<Scalars['BigInt']['input']>;
  currentRound_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
  currentRound_lt?: InputMaybe<Scalars['BigInt']['input']>;
  currentRound_lte?: InputMaybe<Scalars['BigInt']['input']>;
  currentRound_not?: InputMaybe<Scalars['BigInt']['input']>;
  currentRound_not_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
  exchangeAssetToken?: InputMaybe<Scalars['String']['input']>;
  exchangeAssetToken_?: InputMaybe<Token_Filter>;
  exchangeAssetToken_contains?: InputMaybe<Scalars['String']['input']>;
  exchangeAssetToken_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  exchangeAssetToken_ends_with?: InputMaybe<Scalars['String']['input']>;
  exchangeAssetToken_ends_with_nocase?: InputMaybe<Scalars['String']['input']>;
  exchangeAssetToken_gt?: InputMaybe<Scalars['String']['input']>;
  exchangeAssetToken_gte?: InputMaybe<Scalars['String']['input']>;
  exchangeAssetToken_in?: InputMaybe<Array<Scalars['String']['input']>>;
  exchangeAssetToken_lt?: InputMaybe<Scalars['String']['input']>;
  exchangeAssetToken_lte?: InputMaybe<Scalars['String']['input']>;
  exchangeAssetToken_not?: InputMaybe<Scalars['String']['input']>;
  exchangeAssetToken_not_contains?: InputMaybe<Scalars['String']['input']>;
  exchangeAssetToken_not_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  exchangeAssetToken_not_ends_with?: InputMaybe<Scalars['String']['input']>;
  exchangeAssetToken_not_ends_with_nocase?: InputMaybe<Scalars['String']['input']>;
  exchangeAssetToken_not_in?: InputMaybe<Array<Scalars['String']['input']>>;
  exchangeAssetToken_not_starts_with?: InputMaybe<Scalars['String']['input']>;
  exchangeAssetToken_not_starts_with_nocase?: InputMaybe<Scalars['String']['input']>;
  exchangeAssetToken_starts_with?: InputMaybe<Scalars['String']['input']>;
  exchangeAssetToken_starts_with_nocase?: InputMaybe<Scalars['String']['input']>;
  flavor?: InputMaybe<RoundsVaultFlavor>;
  flavor_in?: InputMaybe<Array<RoundsVaultFlavor>>;
  flavor_not?: InputMaybe<RoundsVaultFlavor>;
  flavor_not_in?: InputMaybe<Array<RoundsVaultFlavor>>;
  id?: InputMaybe<Scalars['ID']['input']>;
  id_gt?: InputMaybe<Scalars['ID']['input']>;
  id_gte?: InputMaybe<Scalars['ID']['input']>;
  id_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  minPositionSize?: InputMaybe<Scalars['BigInt']['input']>;
  minPositionSize_gt?: InputMaybe<Scalars['BigInt']['input']>;
  minPositionSize_gte?: InputMaybe<Scalars['BigInt']['input']>;
  minPositionSize_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
  minPositionSize_lt?: InputMaybe<Scalars['BigInt']['input']>;
  minPositionSize_lte?: InputMaybe<Scalars['BigInt']['input']>;
  minPositionSize_not?: InputMaybe<Scalars['BigInt']['input']>;
  minPositionSize_not_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
  or?: InputMaybe<Array<InputMaybe<RoundsVault_Filter>>>;
  pair?: InputMaybe<Scalars['String']['input']>;
  pair_?: InputMaybe<RoundsVaultPair_Filter>;
...
export enum RoundsVault_OrderBy {
  createdAt = 'createdAt',
  createdAtBlock = 'createdAtBlock',
  currentRound = 'currentRound',
  exchangeAssetToken = 'exchangeAssetToken',
  exchangeAssetToken__decimals = 'exchangeAssetToken__decimals',
  exchangeAssetToken__id = 'exchangeAssetToken__id',
  exchangeAssetToken__lastPriceBlockNumber = 'exchangeAssetToken__lastPriceBlockNumber',
  exchangeAssetToken__lastPriceUSD = 'exchangeAssetToken__lastPriceUSD',
  exchangeAssetToken__name = 'exchangeAssetToken__name',
  exchangeAssetToken__symbol = 'exchangeAssetToken__symbol',
  flavor = 'flavor',
  id = 'id',
  minPositionSize = 'minPositionSize',
  pair = 'pair',
  pair__active = 'pair__active',
  pair__id = 'pair__id',
  pair__institutionId = 'pair__institutionId',
  pair__lastUpdated = 'pair__lastUpdated',
  pair__registeredAt = 'pair__registeredAt',
  pair__registeredAtBlock = 'pair__registeredAtBlock',
  receipts = 'receipts',
  rounds = 'rounds',
  underlyingToken = 'underlyingToken',
  underlyingToken__decimals = 'underlyingToken__decimals',
  underlyingToken__id = 'underlyingToken__id',
  underlyingToken__lastPriceBlockNumber = 'underlyingToken__lastPriceBlockNumber',
  underlyingToken__lastPriceUSD = 'underlyingToken__lastPriceUSD',
...
export type Vault = {
  ...
  inputTokenPriceUSD?: Maybe<Scalars['BigDecimal']['output']>;
  institution: Institution;
  /**  Whether the PAM-V2 whitelist is open (i.e. anyone is treated as whitelisted) for this vault. Driven by ProtocolAccessManagerV2.setWhitelistOpen(context, isOpen).  */
  isWhitelistOpen: Scalars['Boolean']['output'];
  ...
  /**  The rounds-vault pair wrapping this FleetCommander, if any  */
  roundsVaultPair?: Maybe<RoundsVaultPair>;
...
export type Vault_Filter = {
  ...
  institution_starts_with?: InputMaybe<Scalars['String']['input']>;
  institution_starts_with_nocase?: InputMaybe<Scalars['String']['input']>;
  isWhitelistOpen?: InputMaybe<Scalars['Boolean']['input']>;
  isWhitelistOpen_in?: InputMaybe<Array<Scalars['Boolean']['input']>>;
  isWhitelistOpen_not?: InputMaybe<Scalars['Boolean']['input']>;
  isWhitelistOpen_not_in?: InputMaybe<Array<Scalars['Boolean']['input']>>;
  ...
  roundsVaultPair_?: InputMaybe<RoundsVaultPair_Filter>;
  stakedOutputTokenAmount?: InputMaybe<Scalars['BigInt']['input']>;
  stakedOutputTokenAmount_gt?: InputMaybe<Scalars['BigInt']['input']>;
  stakedOutputTokenAmount_gte?: InputMaybe<Scalars['BigInt']['input']>;
  stakedOutputTokenAmount_in?: InputMaybe<Array<Scalars['BigInt']['input']>>;
...
export enum Vault_OrderBy {
  ...
  roundsVaultPair = 'roundsVaultPair',
  roundsVaultPair__active = 'roundsVaultPair__active',
  roundsVaultPair__id = 'roundsVaultPair__id',
  roundsVaultPair__institutionId = 'roundsVaultPair__institutionId',
  roundsVaultPair__lastUpdated = 'roundsVaultPair__lastUpdated',
  roundsVaultPair__registeredAt = 'roundsVaultPair__registeredAt',
  roundsVaultPair__registeredAtBlock = 'roundsVaultPair__registeredAtBlock',
  stakedOutputTokenAmount = 'stakedOutputTokenAmount',
...
export enum YieldAggregator_OrderBy {
  _hourlySnapshotsDeepCleaned = '_hourlySnapshotsDeepCleaned',
  cumulativeProtocolSideRevenueUSD = 'cumulativeProtocolSideRevenueUSD',
  cumulativeSupplySideRevenueUSD = 'cumulativeSupplySideRevenueUSD',
  cumulativeTotalRevenueUSD = 'cumulativeTotalRevenueUSD',
  cumulativeUniqueUsers = 'cumulativeUniqueUsers',
...
export type GetRwaRoundsVaultPairQueryVariables = Exact<{
  fleet: Scalars['String']['input'];
}>;


export type GetRwaRoundsVaultPairQuery = { __typename?: 'Query', roundsVaultPairs: Array<{ __typename?: 'RoundsVaultPair', id: string, inputVault?: { __typename?: 'RoundsVault', id: string } | null, outputVault?: { __typename?: 'RoundsVault', id: string } | null }> };

export type GetRwaReceiptsHistoryPageQueryVariables = Exact<{
...
export type GetRwaReceiptsHistoryPageQuery = { __typename?: 'Query', receipts: Array<{ __typename?: 'Receipt', id: string, balance: number, vault: { __typename?: 'RoundsVault', id: string, flavor: RoundsVaultFlavor }, round: { __typename?: 'Round', roundId: number, state: RoundState, openedAt: number, settledAt?: number | null }, activities: Array<{ __typename?: 'ReceiptActivity', type: ReceiptActivityType, timestamp: number, txHash: string, assetAmount?: number | null, receiptAmount: number, assetToken?: { __typename?: 'Token', symbol: string, decimals: number } | null }> }> };
...
export const GetRwaRoundsVaultPairDocument = /*#__PURE__*/ gql`
  ...
  roundsVaultPairs(where: {targetVault: $fleet}) {
    ...
    `;
export const GetRwaReceiptsHistoryPageDocument = /*#__PURE__*/ gql`
    query GetRwaReceiptsHistoryPage($account: String!, $vault: String!, $first: Int!, $skip: Int!) {
  receipts(
    first: $first
    skip: $skip
    orderBy: lastUpdated
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetRwaRoundsVaultPair(variables: GetRwaRoundsVaultPairQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetRwaRoundsVaultPairQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetRwaRoundsVaultPairQuery>({ document: GetRwaRoundsVaultPairDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetRwaRoundsVaultPair', 'query', variables);
    },
    GetRwaReceiptsHistoryPage(variables: GetRwaReceiptsHistoryPageQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetRwaReceiptsHistoryPageQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetRwaReceiptsHistoryPageQuery>({ document: GetRwaReceiptsHistoryPageDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetRwaReceiptsHistoryPage', 'query', variables);
    }
  };
}
