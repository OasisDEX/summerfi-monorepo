...
export type GetTopDepositorsQuery = { __typename?: 'Query', positions: Array<{ __typename?: 'Position', inputTokenBalance: number, inputTokenBalanceNormalized: number, inputTokenBalanceNormalizedInUSD: number, account: { __typename?: 'Account', id: string }, deposits: Array<{ __typename?: 'Deposit', timestamp: number, amount: number }>, withdrawals: Array<{ __typename?: 'Withdraw', timestamp: number, amount: number }>, vault: { __typename?: 'Vault', name?: string | null, id: string, rebalanceCount: number, inputTokenPriceUSD?: number | null, inputToken: { __typename?: 'Token', id: string, symbol: string, decimals: number }, protocol: { __typename?: 'YieldAggregator', network: Network } } }> };


export const GetTopDepositorsDocument = /*#__PURE__*/ gql`
