...
export const GRAVITY_RADIUS_GROW_SPEED = 300
export const GRAVITY_RADIUS_SHRINK_SPEED = 400
...
export const COMET_DEBRIS_SPREAD = 0.8
export const COMET_DEBRIS_LIFETIME_MIN = 0.001
export const COMET_DEBRIS_LIFETIME_MAX = 1
