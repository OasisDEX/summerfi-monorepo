...
export const SummerFiProBox = () => {
  ...
  const handleSummerFiProBoxClick = (button: string) => () => {
    EarnProtocolEvents.buttonClicked({
      buttonName: `lp-summerfi-pro-box-${button}`,
      page: pathname,
    })
  }
    ...
    <GradientBox selected className={summerFiProBoxStyles.summerProInfoBox}>
      <Card variant="cardGradientLight" className={summerFiProBoxStyles.summerProInfoBoxCard}>
        ...
        <Text variant="p3semi" className={summerFiProBoxStyles.summerProInfoBoxLinks}>
          <Link
            href={`${INTERNAL_LINKS.summerPro}/multiply`}
            onClick={handleSummerFiProBoxClick('multiply')}
            target="_blank"
            prefetch={false}
          >
            Multiply
          ...
          &nbsp;・&nbsp;
          <Link
            href={`${INTERNAL_LINKS.summerPro}/borrow`}
            onClick={handleSummerFiProBoxClick('borrow')}
            target="_blank"
            prefetch={false}
          >
            Borrow
          ...
          &nbsp;・&nbsp;
          <Link
            href={`${INTERNAL_LINKS.summerPro}/earn`}
            onClick={handleSummerFiProBoxClick('earn')}
            target="_blank"
            prefetch={false}
          >
            Yield Loops
