    ...
    <div className={styles.privacyPageWrapper}>
      <div className={styles.contentWrapper}>
        ...
        <Text as="p" variant="p2" className={styles.p2}>
          ...
          website and other websites which use subdomains of summer.fi (the &quot;Site&quot;). We
          are committed to protecting and respecting your privacy. Please read this carefully as
          this Privacy Policy is legally binding when you use the Site.
        </Text>
        <Text as="p" variant="p2" className={styles.p2}>
          As used in this Privacy Policy, &quot;we&quot;, &quot;us&quot; or &quot;our&quot; refers
          to Oazo Apps Limited, a company incorporated and registered in England, United Kingdom. We
          are the controller and responsible for your personal data. You can reach us with any
          requests relating to this Privacy Policy via the contact details set out in the Contact us
        ...
        <Text
          ...
          variant="p2"
          className={styles.p2}
          style={{ marginBottom: 'var(--spacing-space-medium)' }}
        >
          We have set out below, in a table format, a description of all the ways we plan to use the
          various categories of your personal data, and which of the legal bases we rely on to do
            ...
            <tbody>
              <tr>
                <td style={{ border: '1px solid #ddd', padding: '8px' }}>
                  To register you as a new user including by accessing our website via your
              ...
              <tr>
                ...
                <td style={{ border: '1px solid #ddd', padding: '8px' }}>
                  ...
                  <br />
                  (c) Necessary for our legitimate interests (to keep our records updated and manage
              ...
              <tr>
                <td style={{ border: '1px solid #ddd', padding: '8px' }}>
                  To manage your participation in any referral programmes available through the
                  Site, including Beach Club, including verifying your referrals and sending you
                  rewards
                </td>
                <td style={{ border: '1px solid #ddd', padding: '8px' }}>
                  (a) Identity
              ...
              <tr>
                <td style={{ border: '1px solid #ddd', padding: '8px' }}>
                  To use data analytics to improve our website, products/services, customer
                  relationships and experiences and to measure the effectiveness of our
              ...
              <tr>
                <td style={{ border: '1px solid #ddd', padding: '8px' }}>
                  To send you relevant marketing communications and make personalised suggestions
                  and recommendations to you about services that may be of interest to you based on
                  your Profile Data
                </td>
                <td style={{ border: '1px solid #ddd', padding: '8px' }}>
                  (a) Identity
              ...
              <tr>
                <td style={{ border: '1px solid #ddd', padding: '8px' }}>
                  To carry out market research including through your participation in surveys
                </td>
                <td style={{ border: '1px solid #ddd', padding: '8px' }}>
                  (a) Identity
                  <br />
                ...
                <td style={{ border: '1px solid #ddd', padding: '8px' }}>
                  ...
                  products/services and to help us improve and develop our products and services).
                </td>
              </tr>
            </tbody>
          </table>
        </div>
        <Text as="h5" variant="h5" style={{ marginTop: 'var(--spacing-space-small)' }}>
          Blockchain Data
        </Text>
        <Text as="p" variant="p2" className={styles.p2}>
        ...
        <Text as="p" variant="p2" className={styles.p2}>
          ...
          us or purchased goods or services from us and you have not opted out of receiving the
          marketing.
        </Text>
        <Text as="p" variant="p2" className={styles.p2}>
          We may also analyse your Identity, Contact, Technical, Usage and Profile Data to form a
          view which products, services and offers may be of interest to you so that we can then
        ...
        <Text as="p" variant="p2" className={styles.p2}>
          We will get your express consent before we share your personal data with any third party
        ...
        <Text as="p" variant="p2" className={styles.p2}>
          You can ask to stop sending you marketing communications at any time by following the
          opt-out links within any marketing communication sent to you or by contacting us using the
          details set out in the Contact us section of this Privacy Policy.
        </Text>
        <Text as="p" variant="p2" className={styles.p2}>
          If you opt out of receiving marketing communications, you will still receive
          service-related communications that are essential for administrative or customer service
          purposes for example relating to updates to our Terms and Conditions, checking that your
        ...
        <Text as="p" variant="p2" className={styles.p2}>
          Please note that we may transfer your personal data outside the EU/EEA/UK to third parties
          for the purposes of the data processing and external access by you of services provided by
          those third parties including to jurisdictions not offering the same level of data
          protection as the UK. In such circumstances, we ensure that such transfers are subject to
          appropriate safeguards which give the transferred personal data the same protection as it
          has in the UK.
        </Text>
        <Text as="p" variant="p2" className={styles.p2}>
          To obtain a copy of these contractual safeguards, please contact us using the details set
        ...
        <Text as="p" variant="p2" className={styles.p2}>
          ...
          data. Our security measures are continuously improved in line with technological
          developments.
        </Text>
        <Text as="p" variant="p2" className={styles.p2}>
          Please note that any data transmission on the Internet (e.g. communication by email) is
          generally not secure and, subject to any liability which cannot be excluded under
          applicable law, we accept no liability for data transmitted to us via the Internet.
        </Text>
        <Text as="h4" variant="h4" style={{ marginTop: 'var(--spacing-space-small)' }}>
          Third-party links
        </Text>
        ...
        <Text as="p" variant="p2" className={styles.p2}>
          ...
          purpose of the processing we collected it for, including for the purposes of satisfying
        ...
        <Text as="p" variant="p2" className={styles.p2}>
          As a data subject, you have the right to obtain from us information about your personal
          data processed at any time and a copy of this information. Furthermore, you will have
          access to the following information: the purposes of the processing; the categories of
          personal data concerned; where possible, the envisaged period for which the personal data
          will be processed, or, if not possible, the criteria used to determine that period; the
          existence of the right to request from us rectification or erasure of personal data, or
          restriction of processing of personal data concerning you, or to object to such
        ...
        <Text as="p" variant="p2" className={styles.p2}>
          ...
          personal data concerning you however we may need to verify the accuracy of the new data
          you provide to us. Taking into account the purposes of the processing, you shall have the
        ...
        <Text as="p" variant="p2" className={styles.p2}>
          You have the right to object at any time, to the processing of your personal data where we
          are relying on a legitimate interest (or those of a third party) as the legal basis for
          that particular use of your data. We shall no longer process the personal data in the
          event of the objection unless we can demonstrate reasonable grounds for the processing,
          which override the interests, rights and freedoms of you, or for the establishment,
          exercise or defense of legal claims.
        </Text>
        <Text as="p" variant="p2" className={styles.p2}>
          You also have the absolute right to object any time to the processing of your personal
          data for direct marketing purposes (see Opting out of marketing above for details of how
        ...
        <Text as="p" variant="p2" className={styles.p2}>
          ...
          time. However, this will not affect the lawfulness of any processing carried out before
        ...
        <Text as="p" variant="p2" className={styles.p2}>
          In the event of any conflict or inconsistency between this Privacy Policy and any
          non-English language translation thereof, the terms and provisions of this Privacy Policy
          shall control.
        </Text>
        <Text as="h4" variant="h4" style={{ marginTop: 'var(--spacing-space-small)' }}>
          Contact us
        ...
        <Text as="p" variant="p2" className={styles.p2}>
          Please contact us with questions, comments, or concerns regarding our Privacy Policy as
          well as with any requests at <a href="mailto:legal@summer.fi">legal@summer.fi</a>.
        </Text>
        <Text as="h4" variant="h4" style={{ marginTop: 'var(--spacing-space-small)' }}>
          Complaints
        </Text>
