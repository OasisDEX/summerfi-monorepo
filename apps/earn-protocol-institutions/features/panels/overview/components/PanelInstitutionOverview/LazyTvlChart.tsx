...
// Defers the (O(n)-per-vault) TVL performance fetch off the server render path: the query only
// fires once this block scrolls into view, and TvlChartIntermediary shows its spinner until the
// data arrives. The IntersectionObserver ref sits on the wrapper, which is always rendered.
  ...
  return (
    <div ref={ref} style={{ width: '100%' }}>
      <TvlChartIntermediary
        vaultsTvlChartData={data ?? undefined}
