...
export type GetInstitutionDataQueryVariables = Exact<{
  institutionId: Scalars['ID']['input'];
}>;


export type GetInstitutionDataQuery = { __typename?: 'Query', institution?: { __typename?: 'Institution', id: string, active: boolean, admiralsQuarters: string, harborCommand: string } | null };


export const GetInstitutionDataDocument = /*#__PURE__*/ gql`
    query GetInstitutionData($institutionId: ID!) {
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetInstitutionData(variables: GetInstitutionDataQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetInstitutionDataQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetInstitutionDataQuery>({ document: GetInstitutionDataDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetInstitutionData', 'query', variables);
    }
  };
}
