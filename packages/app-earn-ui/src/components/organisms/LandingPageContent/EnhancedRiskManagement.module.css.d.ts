declare const styles: {
  readonly "bottomBoxDescription": string;
  ...
  readonly "protectedCapital": string;
  readonly "protocolIcon": string;
  readonly "smallGradientBlock": string;
  readonly "topBlock": string;
  readonly "topBlockDescription": string;
  readonly "topBlockProtocolIcons": string;
};
export = styles;
