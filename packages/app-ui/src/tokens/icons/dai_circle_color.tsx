export default {
  path: (
    <g key="EEuRVAa7G">
      <circle cx="12" cy="12" r="10" fill="url(#paint0_linear_dai)" key="8yO-SfArg" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
      ...
      <defs key="ORsEUW6i8">
        ...
        >
          <stop stopColor="#F9A606" key="AecgJNtkMb" />
          <stop offset="1" stopColor="#FBCC5F" key="t5A9ZLdOtA" />
        </linearGradient>
      </defs>
    </g>
  ),
