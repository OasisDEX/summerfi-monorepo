export default {
  path: (
    <>
      <g clipPath="url(#F)" transform="matrix(.846154 0 0 .846154 80.461538 80.461538)">
      ...
      <defs>
        <linearGradient id="A" key="A" x1="145.957" y1="125.704" x2="406.32" y2="946.97">
          <stop stopColor="#f78e1e" key="ITckcSnlLE" />
          <stop offset="1" stopColor="#f2a529" key="r1SaVtM8rN" />
        </linearGradient>
        <linearGradient id="B" key="B" x1="492.624" y1="64.972" x2="544.472" y2="886.794">
          <stop stopColor="#f78e1e" key="srHLc1wAJ6" />
          <stop offset="1" stopColor="#f2a529" key="xdXe3FucLH" />
        </linearGradient>
        <linearGradient id="C" key="C" x1="659.43" y1="216.536" x2="729.976" y2="787.77">
          <stop stopColor="#f78e1e" key="wQrMfZS_y2" />
          <stop offset="1" stopColor="#f2a529" key="HIOv73Vf2Q" />
        </linearGradient>
        <linearGradient id="D" key="D" x1="641.674" y1="104.415" x2="720.783" y2="917.064">
          <stop stopColor="#f78e1e" key="L1jJkY9NZI" />
          <stop offset="1" stopColor="#f2a529" key="d4rgePhIe2" />
        </linearGradient>
        <linearGradient id="E" key="E" x1="209.132" y1="257.156" x2="526.916" y2="923.708">
          <stop stopColor="#f78e1e" key="JtYNcS1ItJ" />
          <stop offset="1" stopColor="#f2a529" key="AxSiY5gOrH" />
        </linearGradient>
        <clipPath id="F" key="F">
