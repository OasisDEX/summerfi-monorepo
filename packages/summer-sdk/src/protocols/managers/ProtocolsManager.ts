import { IProtocol, IProtocolsManager, ProtocolsNames } from "@sdk/protocols";
...
export class ProtocolsManager implements IProtocolsManager {
     ...
     */
    public getProtocol<ProtocolType extends IProtocol>(params: { name: ProtocolsNames }): ProtocolType {
