import { IProtocol, ProtocolsNames } from "@sdk/protocols";
...
export class ProtocolsRegistry {
    /// Class Attributes
    private static _protocols: Map<ProtocolsNames, IProtocol>;
     ...
     */
    public static registerProtocol(params: { name: ProtocolsNames; protocol: IProtocol }): void {
        if (!this._protocols) {
     ...
     */
    public static getProtocol<ProtocolType extends IProtocol>(params: { name: ProtocolsNames }): ProtocolType {
