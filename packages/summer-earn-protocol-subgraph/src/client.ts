...
export type UserPositionsQuery = {
  ...
  positions: Array<{
    ...
    outputTokenBalanceNormalized: number
    outputTokenBalanceNormalizedInUSD: number
  }>
}
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    UserPositions(
      variables: UserPositionsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<UserPositionsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UserPositionsQuery>(UserPositionsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'UserPositions',
