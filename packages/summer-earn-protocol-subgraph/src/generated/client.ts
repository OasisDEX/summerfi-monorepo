...
export type ArkHourlySnapshot = {
  ...
  apr: Scalars['BigDecimal']['output'];
  aprLast1h: Scalars['BigDecimal']['output'];
  /**  The ark this snapshot belongs to  */
  ark: Ark;
  /**  Block number of this snapshot  */
  blockNumber: Scalars['BigInt']['output'];
...
export type ArkHourlySnapshot_Filter = {
  ...
  apr?: InputMaybe<Scalars['BigDecimal']['input']>;
  aprLast1h?: InputMaybe<Scalars['BigDecimal']['input']>;
  aprLast1h_gt?: InputMaybe<Scalars['BigDecimal']['input']>;
  aprLast1h_gte?: InputMaybe<Scalars['BigDecimal']['input']>;
  aprLast1h_in?: InputMaybe<Array<Scalars['BigDecimal']['input']>>;
  aprLast1h_lt?: InputMaybe<Scalars['BigDecimal']['input']>;
  aprLast1h_lte?: InputMaybe<Scalars['BigDecimal']['input']>;
  aprLast1h_not?: InputMaybe<Scalars['BigDecimal']['input']>;
  aprLast1h_not_in?: InputMaybe<Array<Scalars['BigDecimal']['input']>>;
  apr_gt?: InputMaybe<Scalars['BigDecimal']['input']>;
  apr_gte?: InputMaybe<Scalars['BigDecimal']['input']>;
  apr_in?: InputMaybe<Array<Scalars['BigDecimal']['input']>>;
  apr_lt?: InputMaybe<Scalars['BigDecimal']['input']>;
