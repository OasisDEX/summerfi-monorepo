import { DependencyConfigEntry } from '~deployment-config'
...
export type MakerProtocolCommonConfig = Record<MakerContractNames, DependencyConfigEntry>
export type MakerProtocolJoinConfig = Record<MakerProtocolJoins, DependencyConfigEntry>
export type MakerProtocolPipConfig = Record<MakerProtocolPips, DependencyConfigEntry>
