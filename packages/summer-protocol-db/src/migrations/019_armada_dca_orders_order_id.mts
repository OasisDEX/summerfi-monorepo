...
export async function up(db: Kysely<never>): Promise<void> {
  ...
  // Drop indexes created in `down()` before dropping the table.
...
export async function down(db: Kysely<never>): Promise<void> {
  await db.schema
    ...
    .addColumn('in_asset', 'varchar', (col) => col.notNull())
    .addColumn('out_asset', 'varchar', (col) => col.notNull())
    .addColumn('in_asset_feed', 'varchar', (col) => col.notNull())
    .addColumn('out_asset_feed', 'varchar', (col) => col.notNull())
    .execute()
