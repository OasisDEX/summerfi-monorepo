...
export async function up(db: Kysely<never>): Promise<void> {
  await db.schema
    ...
    .addColumn('rebalance_id', 'varchar(66)', (col) => col.notNull())
    ...
    .addColumn('from_deposit_limit', 'decimal(78, 18)', (col) => col.notNull())
    .addColumn('from_total_value_locked_usd', 'decimal(78, 18)', (col) => col.notNull())
    .addColumn('to_name', 'varchar(255)', (col) => col.notNull())
    .addColumn('to_deposit_limit', 'decimal(78, 18)', (col) => col.notNull())
