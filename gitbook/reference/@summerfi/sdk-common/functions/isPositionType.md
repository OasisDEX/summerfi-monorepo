# Function: isPositionType()

```ts
function isPositionType(maybePositionType): maybePositionType is PositionType;
```

Defined in: [src/common/enums/PositionType.ts:31](https://github.com/OasisDEX/summerfi-monorepo/blob/dev/src/common/enums/PositionType.ts#L31)
